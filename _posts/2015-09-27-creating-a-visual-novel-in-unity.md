...
![Creation]({{ site.url }}/assets/01_Creation.png)

## Scene View

![Blank Unity]({{ site.url }}/assets/02_BlankUnity.png)
...
![Gizmo]({{ site.url }}/assets/03_Gizmo.png)
...
![Hierarchy]({{ site.url }}/assets/04_Hierarchy.png)
...
![Scene Save]({{ site.url }}/assets/05_SaveScene.png)
...
![Project Browser]({{ site.url }}/assets/06_ProjectBrowser.png)
...
![Canvas]({{ site.url }}/assets/07_Canvas.png)
...
![Image Inspector]({{ site.url }}/assets/08_BackgroundImageInspector.png)
...
![Image Background]({{ site.url }}/assets/09_ImageBackground.png)
...
![Background Canvas]({{ site.url }}/assets/10_BackgroundCanvasTranslate.png)
...
![Toolbar]({{ site.url }}/assets/11_Toolbar.png)
...
![Stretched Background]({{ site.url }}/assets/12_StretchedBackground.png)
...
![Panel]({{ site.url }}/assets/13_Panel.png)
...
![Dialog Boxes]({{ site.url }}/assets/14_DialogueParser.png)
...
![Dialog]({{ site.url }}/assets/15_Dialog.png)
...
![Create Empty]({{ site.url }}/assets/16_CreateEmpty.png)
...
![Dialgoue Parser]({{ site.url }}/assets/17_DialogueParserObject.png)
...
![Button]({{ site.url }}/assets/18_Button.png)
...
![Choice Button]({{ site.url }}/assets/19_ChoiceButton.png)
...
![Prefab]({{ site.url }}/assets/20_Prefab.png)
...
![OnClick]({{ site.url }}/assets/21_OnClick.png)
...
![Characters]({{ site.url }}/assets/22_Characters.png)
...
![Character Poses]({{ site.url }}/assets/23_CharacterPoses.png)
...
![Character Prefabs]({{ site.url }}/assets/24_CharacterPrefabs.png)
...
![Dialogue Manager]({{ site.url }}/assets/25_DialogeManager.png)
...
![Button Prefab]({{ site.url }}/assets/26_ButtonPrefabs.png)
